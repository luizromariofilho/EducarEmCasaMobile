 ...
 */
public class DetalhesFilhoFaltaListAdapter extends BaseAdapter {
    private List<DetalhesFilho> detalhesFilhos;
    private Context context;

    public DetalhesFilhoFaltaListAdapter(List<DetalhesFilho> detalhesFilhos, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(detalhesFilho.getD_nome() + " - " + detalhesFilho.getS_valor() + " - " + detalhesFilho.getF_valor());
